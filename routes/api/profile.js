...
router.post(
  ...
  (req, res) => {
    ...
    if (req.body.jhs) profileFields.jhs = req.body.jhs;
    if (req.body.shs) profileFields.shs = req.body.shs;
    if (req.body.campus_residence)
      profileFields.campus_residence = req.body.campus_residence;
